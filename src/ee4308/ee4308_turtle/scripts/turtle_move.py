...
from turtle_constants import MIN_V, MAX_V, MAX_W, MAX_DV, \
...
#            if err_ang < TURN_THRESHOLD and err_ang > -TURN_THRESHOLD:
#                cmd_v = (1 - abs(err_ang)/TURN_THRESHOLD)
#            elif err_ang > pi-TURN_THRESHOLD:
#                cmd_v = -(1 - (pi-err_ang)/TURN_THRESHOLD)
#            elif err_ang < -pi+TURN_THRESHOLD:
#                cmd_v = -(1 - (err_ang+pi)/TURN_THRESHOLD)
#            else:
#                cmd_v = 0
            ...
            if t_err > ITERATION_PERIOD:
                print('[ MOVE ] {}ms OVERSHOOT'.format(int(t_err*1000)))
